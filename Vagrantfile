...
mysql_root_password   = "x6L8CxaEPuZeAxns"   # We'll assume user "root"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "tester.dev" do |laradev|
  end
  ...
  # Provision Local apt-get-ng cache for quicker retreival of packages
  config.vm.provision "shell", path: "#{github_url}/scripts/local-aptget-cache.sh"
